...
instance_score = 0 # Added to Remove bug in game where Score changes while still in menu
high_score = 0 
...
score_surf = game_font.render("0", False, "Black")
...
while running:
    ...
    if game_state == STATE_PLAYING:
        ...
        # Levels 'UP' the player once it reaches a threshold. Changing soon as I add projectiles and more stuff
    ...
    # When game is over, display game over message
        ...
        final_score_surf = small_font.render(
            f"Your Score: {instance_score}   Best: {high_score}", False, "Black"
        )
